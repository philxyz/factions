...
function ENT:Initialize()
	...
	self.Entity:SetColor( Color(10, 96, 180, 255) )
end

function ENT:TurnOn()
	if (self.Active == 0) then
		self.Active = 1
		if (self.damaged == 0) then self.Entity:SetColor( Color(10, 96, 255, 255) ) end --light up blue when on
		self:SetOOO(1)
	end
end
...
function ENT:TurnOff()
	if (self.Active == 1) then
		self.Active = 0
		if (self.damaged == 0) then self.Entity:SetColor( Color(10, 96, 180, 255) ) end --go dark when off
		self:SetOOO(0)
...
function ENT:Repair()
	self.Entity:SetColor( Color(10, 96, 255, 255) )
